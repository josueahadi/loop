...
The cargo-owner + driver mobile app for Loop. Talks to the NestJS API (`../api`),
which is the system of record. State management is `provider`; networking is a single
Dio client (`lib/core/api/`) that attaches the JWT and refreshes it on 401.
