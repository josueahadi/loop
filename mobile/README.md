...
- **Server side:** the API must run with `PUSH_DRIVER=fcm` and the `loop-rw` service-account credentials — see [DEPLOYMENT.md section 7 (Push notifications)](../DEPLOYMENT.md#7-push-notifications-fcm).
