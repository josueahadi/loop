...
void initState() {
  ...
  Future<void> _completeRegistration() async {
    ...
    if (success && mounted) {
      // Driver verification documents (licence, national ID, vehicle registration)
      // are uploaded as files through the verification screen (POST /verification),
      // not captured as text here. Proceed to email verification after signup.
